...
- [[incident-2026-09-04-precompute-ai-double-schedule]] — `precompute-ai.yml` (GHA) and `deploy/precompute-ai/modal_app.py` (Modal) both scheduled for the same cron minute; likely latent since Modal has never been deployed ([[incident-2026-08-18-modal-under-recommended]]), but fixed before it becomes an active OpenRouter-quota double-spend
