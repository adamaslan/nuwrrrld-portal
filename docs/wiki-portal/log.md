...
## [2026-09-02] ingest | PR #97 feat(council): MOO ETF investment simulation + council model-chain fixes | pages touched: 3
...
## [2026-09-11] ingest | portfolio health local fallback — stop waiting on gcp3's never-deployed route | pages touched: 10
...
## [2026-09-14] ingest | PR TBD feat(paper-portfolios): cron workflow (Phase 4) | pages touched: 2
